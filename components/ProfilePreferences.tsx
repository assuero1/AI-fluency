...
import { Check, Download, Loader2, ShieldAlert, Trash2 } from "lucide-react";
        ...
        <div className="settings-list">
          {correctionOptions.map((option) => (
            <button
              ...
              type="button"
            >
              {preferences.correctionStyle === option.value ? <Check aria-hidden="true" size={16} /> : <span aria-hidden="true" className="choice-placeholder" />}
      ...
      <section className="section">
        ...
        <div className="settings-list">
          ...
          <button className="settings-row destructive-row" disabled={pending === "delete-challenge"} onClick={openDeleteConfirmation} type="button">
            ...
            {pending === "delete-challenge" ? <Loader2 aria-hidden="true" className="animate-spin" size={20} /> : <ShieldAlert aria-hidden="true" size={20} />}
          </button>
        </div>
      </section>
        ...
        >
            ...
            <div className="modal-actions">
              ...
              <button className="danger-button" disabled={pending === "delete-history" || deletePhrase.trim().length === 0} onClick={deleteHistory} type="button">
                {pending === "delete-history" ? <Loader2 aria-hidden="true" className="animate-spin" size={20} /> : <Trash2 aria-hidden="true" size={20} />}
                Limpar histórico
              </button>
            </div>
        </ModalDialog>
